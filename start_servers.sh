...
#$SERVER localhost 4001 localhost 4002 &
...
#$SERVER localhost 4010 localhost 4001 &
#$SERVER localhost 4001 localhost 4010 localhost 4002 localhost 4003 &
...
$SERVER localhost 4010 localhost 4001 localhost 4003 &
$SERVER localhost 4001 localhost 4010 localhost 4002 localhost 4004 &
$SERVER localhost 4002 localhost 4001 localhost 4005 &
$SERVER localhost 4003 localhost 4010 localhost 4004 localhost 4006 &

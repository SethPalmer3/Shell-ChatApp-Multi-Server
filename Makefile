...
server: server.c connection_handler.c channels.c helper_functions.c server_struc.c
	$(CC) server.c connection_handler.c channels.c helper_functions.c server_struc.c $(CFLAGS) -o server
